...
export const FOCUS_MODE_STYLES = {
  ...
  container: {
    ...
    spacing:
      "top-[calc(0.5rem+var(--memore-android-safe-top))] left-2 right-2 bottom-2 sm:top-[calc(1rem+var(--memore-android-safe-top))] sm:left-4 sm:right-4 sm:bottom-4 md:top-[calc(2rem+var(--memore-android-safe-top))] md:left-8 md:right-8 md:bottom-8",
  },
