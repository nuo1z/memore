...
const MemoView: React.FC<MemoViewProps> = (props: MemoViewProps) => {
  ...
  const [editorInitialFocusMode, setEditorInitialFocusMode] = useState(false);
  ...
  const closeEditor = () => {
    setShowEditor(false);
    setEditorInitialFocusMode(false);
  };
  ...
  const openEditorInFocusMode = () => {
    setEditorInitialFocusMode(true);
    setShowEditor(true);
  };
  ...
  if (showEditor) {
    return (
      <MemoEditor
        ...
        memo={memoData}
        initialFocusMode={editorInitialFocusMode}
