...
func (s *Store) GetInstanceGeneralSetting(ctx context.Context) (*storepb.InstanceGeneralSetting, error) {
	...
	if instanceSetting != nil {
		...
		instanceGeneralSetting.WeekStartDayOffset = DefaultWeekStartDayOffset
	}
...
// DefaultWeekStartDayOffset is the default week start day offset (1 = Monday).
const DefaultWeekStartDayOffset = 1
